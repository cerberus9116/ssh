...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%40s%s%-12s\n' "SSHPLUS PRO CRACKED! x86 V10" ; tput sgr0
echo -e "\033[1;31m════════════════════════════════════════════════════\033[0m"
echo ""
echo ""
...
apt purge sslh -y
if ! grep -q "::ffff:9843:3647 sshplus.xyz" /etc/hosts; then
    echo "::ffff:9843:3647 sshplus.xyz" >> /etc/hosts
fi
if ! grep -q "::ffff:9843:3647 https://sshplus.xyz" /etc/hosts; then
    echo "::ffff:9843:3647 https://sshplus.xyz" >> /etc/hosts
fi
if ! grep -q "152.67.54.71 https://sshplus.xyz" /etc/hosts; then
    echo "152.67.54.71 https://sshplus.xyz" >> /etc/hosts
fi
if ! grep -q "152.67.54.71 sshplus.xyz" /etc/hosts; then
    echo "152.67.54.71 sshplus.xyz" >> /etc/hosts
fi
...
if ! grep -q "::ffff:9843:3647 sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "::ffff:9843:3647 sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
if ! grep -q "::ffff:9843:3647 https://sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "::ffff:9843:3647 https://sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
if ! grep -q "152.67.54.71 https://sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "152.67.54.71 https://sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
if ! grep -q  "152.67.54.71 sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "152.67.54.71 sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
sysctl -p
